...
import {userSignUp} from '../services/FacebookService'
...
export const SignUp = () => {
  ...
  return (
    <Grid main sx={{ bgcolor: "#DCDCDC", textAlign: "center", height: 700 }}>
      ...
      <Card sx={{ maxWidth: 400, height: 430, borderRadius: 2, ml: 72 }}>
        ...
        <Link sx={{mb:2}}onClick={() => navigate(-1)}>Already have an account?</Link>
      </Card>
    </Grid>
  );
};
